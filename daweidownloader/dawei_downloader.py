"""
Dawei E-shop Downloader

Downloads product data from Dawei e-shop and exports to CSV.

Usage:
    python dawei_downloader.py --result_folder H:/Desaka/Dawei --debug --overwrite
"""
...
from daweilib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from daweilib.category_link_extractor import extract_category_links
from daweilib.category_pages_link_extractor import extract_all_category_pages_links
from daweilib.product_detail_link_extractor import extract_all_product_detail_links
from daweilib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Dawei E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Dawei Downloader Started")
    logging.info("=" * 80)
