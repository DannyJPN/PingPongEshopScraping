"""
Extracts category links from Joola main page.

Joola.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from joolalib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Joola uses Shopify - looks for /collections/ URLs in navigation.
