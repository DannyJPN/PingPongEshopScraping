"""
Joola E-shop Downloader

Downloads product data from Joola e-shop and exports to CSV.

Usage:
    python joola_downloader.py --result_folder H:/Desaka/Joola --debug --overwrite
"""
...
from joolalib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from joolalib.category_link_extractor import extract_category_links
from joolalib.category_pages_link_extractor import extract_all_category_pages_links
from joolalib.product_detail_link_extractor import extract_all_product_detail_links
from joolalib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Joola E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Joola Downloader Started")
    logging.info("=" * 80)
