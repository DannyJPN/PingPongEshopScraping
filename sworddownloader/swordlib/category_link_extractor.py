"""
Extracts category links from Sword main page.

Sword.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from swordlib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Sword uses Shopify - looks for /collections/ URLs in navigation.
