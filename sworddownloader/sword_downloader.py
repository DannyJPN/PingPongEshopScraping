"""
Sword E-shop Downloader

Downloads product data from Sword e-shop and exports to CSV.

Usage:
    python sword_downloader.py --result_folder H:/Desaka/Sword --debug --overwrite
"""
...
from swordlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from swordlib.category_link_extractor import extract_category_links
from swordlib.category_pages_link_extractor import extract_all_category_pages_links
from swordlib.product_detail_link_extractor import extract_all_product_detail_links
from swordlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Sword E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Sword Downloader Started")
    logging.info("=" * 80)
