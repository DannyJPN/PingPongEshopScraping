"""
Hanno E-shop Downloader

Downloads product data from Hanno e-shop and exports to CSV.

Usage:
    python hanno_downloader.py --result_folder H:/Desaka/Hanno --debug --overwrite
"""
...
from hannolib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from hannolib.category_link_extractor import extract_category_links
from hannolib.category_pages_link_extractor import extract_all_category_pages_links
from hannolib.product_detail_link_extractor import extract_all_product_detail_links
from hannolib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Hanno E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Hanno Downloader Started")
    logging.info("=" * 80)
