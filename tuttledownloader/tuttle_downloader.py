"""
Tuttle E-shop Downloader

Downloads product data from Tuttle e-shop and exports to CSV.

Usage:
    python tuttle_downloader.py --result_folder H:/Desaka/Tuttle --debug --overwrite
"""
...
from tuttlelib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from tuttlelib.category_link_extractor import extract_category_links
from tuttlelib.category_pages_link_extractor import extract_all_category_pages_links
from tuttlelib.product_detail_link_extractor import extract_all_product_detail_links
from tuttlelib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Tuttle E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Tuttle Downloader Started")
    logging.info("=" * 80)
