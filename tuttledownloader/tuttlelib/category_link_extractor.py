"""
Extracts category links from Tuttle main page.

Tuttle.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from tuttlelib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Tuttle uses Shopify - looks for /collections/ URLs in navigation.
