"""
Hallmark E-shop Downloader

Downloads product data from Hallmark e-shop and exports to CSV.

Usage:
    python hallmark_downloader.py --result_folder H:/Desaka/Hallmark --debug --overwrite
"""
...
from hallmarklib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from hallmarklib.category_link_extractor import extract_category_links
from hallmarklib.category_pages_link_extractor import extract_all_category_pages_links
from hallmarklib.product_detail_link_extractor import extract_all_product_detail_links
from hallmarklib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Hallmark E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Hallmark Downloader Started")
    logging.info("=" * 80)
