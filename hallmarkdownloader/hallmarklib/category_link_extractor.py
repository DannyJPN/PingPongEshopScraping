"""
Extracts category links from Hallmark main page.

Hallmark.tt uses Shopify platform with standard collection structure.
"""
import logging
...
def extract_category_links(main_page_soup):
    ...
    Hallmark uses Shopify - looks for /collections/ URLs in navigation.
