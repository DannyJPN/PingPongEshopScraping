"""
Spinlord E-shop Downloader

Downloads product data from Spinlord e-shop and exports to CSV.

Usage:
    python spinlord_downloader.py --result_folder H:/Desaka/Spinlord --debug --overwrite
"""
...
from spinlordlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from spinlordlib.category_link_extractor import extract_category_links
from spinlordlib.category_pages_link_extractor import extract_all_category_pages_links
from spinlordlib.product_detail_link_extractor import extract_all_product_detail_links
from spinlordlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Spinlord E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Spinlord Downloader Started")
    logging.info("=" * 80)
