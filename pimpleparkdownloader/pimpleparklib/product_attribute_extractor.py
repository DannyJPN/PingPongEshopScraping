"""
Extracts product attributes from PimplePark product detail pages.

PimplePark uses Shopware/WooCommerce platform - German e-commerce:
...
from pimpleparklib.constants import MAIN_URL
