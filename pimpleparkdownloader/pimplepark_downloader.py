"""
PimplePark E-shop Downloader

Downloads product data from PimplePark e-shop and exports to CSV.

Usage:
    python pimplepark_downloader.py --result_folder H:/Desaka/PimplePark --debug --overwrite
"""
...
from pimpleparklib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from pimpleparklib.category_link_extractor import extract_category_links
from pimpleparklib.category_pages_link_extractor import extract_all_category_pages_links
from pimpleparklib.product_detail_link_extractor import extract_all_product_detail_links
from pimpleparklib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="PimplePark E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("PimplePark Downloader Started")
    logging.info("=" * 80)
