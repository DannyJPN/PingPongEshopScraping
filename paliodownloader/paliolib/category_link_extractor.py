"""
Extracts category links from Palio main page.

Palio.tt uses Shopify platform with standard collection structure.
"""
import logging
...
def extract_category_links(main_page_soup):
    ...
    Palio uses Shopify - looks for /collections/ URLs in navigation.
