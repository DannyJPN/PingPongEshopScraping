"""
Palio E-shop Downloader

Downloads product data from Palio e-shop and exports to CSV.

Usage:
    python palio_downloader.py --result_folder H:/Desaka/Palio --debug --overwrite
"""
...
from paliolib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from paliolib.category_link_extractor import extract_category_links
from paliolib.category_pages_link_extractor import extract_all_category_pages_links
from paliolib.product_detail_link_extractor import extract_all_product_detail_links
from paliolib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Palio E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Palio Downloader Started")
    logging.info("=" * 80)
