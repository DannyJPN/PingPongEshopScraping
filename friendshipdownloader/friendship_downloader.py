"""
Friendship (729) E-shop Downloader

Downloads product data from Friendship (729) e-shop and exports to CSV.

Usage:
    python friendship_downloader.py --result_folder H:/Desaka/Friendship --debug --overwrite
"""
...
from friendshiplib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from friendshiplib.category_link_extractor import extract_category_links
from friendshiplib.category_pages_link_extractor import extract_all_category_pages_links
from friendshiplib.product_detail_link_extractor import extract_all_product_detail_links
from friendshiplib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Friendship (729) E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Friendship (729) Downloader Started")
    logging.info("=" * 80)
