"""
Extracts category links from Friendship main page.

Friendship.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from friendshiplib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Friendship uses Shopify - looks for /collections/ URLs in navigation.
