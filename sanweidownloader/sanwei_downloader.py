"""
Sanwei E-shop Downloader

Downloads product data from Sanwei e-shop and exports to CSV.

Usage:
    python sanwei_downloader.py --result_folder H:/Desaka/Sanwei --debug --overwrite
"""
...
from sanweilib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from sanweilib.category_link_extractor import extract_category_links
from sanweilib.category_pages_link_extractor import extract_all_category_pages_links
from sanweilib.product_detail_link_extractor import extract_all_product_detail_links
from sanweilib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Sanwei E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Sanwei Downloader Started")
    logging.info("=" * 80)
