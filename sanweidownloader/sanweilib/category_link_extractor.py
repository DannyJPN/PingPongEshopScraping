"""
Extracts category links from Sanwei main page.

Sanwei.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from sanweilib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Sanwei uses Shopify - looks for /collections/ URLs in navigation.
