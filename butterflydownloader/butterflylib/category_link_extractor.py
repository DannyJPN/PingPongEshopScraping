"""
Extracts category links from Butterfly main page.

Butterfly.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from butterflylib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Butterfly uses Shopify - looks for /collections/ URLs in navigation.
