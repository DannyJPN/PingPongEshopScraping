"""
Butterfly E-shop Downloader

Downloads product data from Butterfly e-shop and exports to CSV.

Usage:
    python butterfly_downloader.py --result_folder H:/Desaka/Butterfly --debug --overwrite
"""
...
from butterflylib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from butterflylib.category_link_extractor import extract_category_links
from butterflylib.category_pages_link_extractor import extract_all_category_pages_links
from butterflylib.product_detail_link_extractor import extract_all_product_detail_links
from butterflylib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Butterfly E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Butterfly Downloader Started")
    logging.info("=" * 80)
