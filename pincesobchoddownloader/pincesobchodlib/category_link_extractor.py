"""
Extracts category links from Pincesobchod main page.

Pincesobchod.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from pincesobchodlib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Pincesobchod uses Shopify - looks for /collections/ URLs in navigation.
