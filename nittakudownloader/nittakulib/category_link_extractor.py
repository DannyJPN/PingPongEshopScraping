"""
Extracts category links from Nittaku main page.

Nittaku.tt uses Shopify platform with standard collection structure.
"""
import logging
...
def extract_category_links(main_page_soup):
    ...
    Nittaku uses Shopify - looks for /collections/ URLs in navigation.
