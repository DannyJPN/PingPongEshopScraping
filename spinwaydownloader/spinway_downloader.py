...
from spinwaylib.category_link_extractor import extract_category_links
...
from spinwaylib.product_detail_link_extractor import extract_all_product_detail_links
from shared.product_detail_page_downloader import download_product_detail_pages
from spinwaylib.product_attribute_extractor import extract_products
from spinwaylib.category_pages_link_extractor import extract_all_category_pages_links
...
from spinwaylib.constants import DEFAULT_RESULT_FOLDER  
...
from spinwaylib.constants import MAIN_PAGE_FILENAME,CSV_OUTPUT_NAME, LOG_DIR
...
def parse_arguments():
    parser = ArgumentParser(description="SpinWayDownloader")
