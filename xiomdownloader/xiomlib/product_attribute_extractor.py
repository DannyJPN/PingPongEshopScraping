"""
Extracts product attributes from Xiom product detail pages.

Xiom uses Shopify platform - utilizes Shopify standard structure:
...
from xiomlib.constants import MAIN_URL
