"""
Xiom E-shop Downloader

Downloads product data from Xiom e-shop and exports to CSV.

Usage:
    python xiom_downloader.py --result_folder H:/Desaka/Xiom --debug --overwrite
"""
...
from xiomlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from xiomlib.category_link_extractor import extract_category_links
from xiomlib.category_pages_link_extractor import extract_all_category_pages_links
from xiomlib.product_detail_link_extractor import extract_all_product_detail_links
from xiomlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Xiom E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Xiom Downloader Started")
    logging.info("=" * 80)
