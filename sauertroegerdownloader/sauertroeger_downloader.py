"""
Sauer${BRAND_DISPLAY}Troeger E-shop Downloader

Downloads product data from Sauer${BRAND_DISPLAY}Troeger e-shop and exports to CSV.

Usage:
    python sauertroeger_downloader.py --result_folder H:/Desaka/SauerTroeger --debug --overwrite
"""
...
from sauertroegerlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from sauertroegerlib.category_link_extractor import extract_category_links
from sauertroegerlib.category_pages_link_extractor import extract_all_category_pages_links
from sauertroegerlib.product_detail_link_extractor import extract_all_product_detail_links
from sauertroegerlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Sauer${BRAND_DISPLAY}Troeger E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Sauer${BRAND_DISPLAY}Troeger Downloader Started")
    logging.info("=" * 80)
