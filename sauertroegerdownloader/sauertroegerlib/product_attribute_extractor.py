"""
Extracts product attributes from Sauer&Troeger product detail pages.

Sauer&Troeger uses Shopware/WooCommerce platform - German e-commerce:
...
from sauertroegerlib.constants import MAIN_URL
