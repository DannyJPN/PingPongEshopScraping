"""
Der Materialspezialist E-shop Downloader

Downloads product data from Der Materialspezialist e-shop and exports to CSV.

Usage:
    python dermaterialspezialist_downloader.py --result_folder H:/Desaka/DerMaterialspezialist --debug --overwrite
"""
...
from dermaterialspezialistlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from dermaterialspezialistlib.category_link_extractor import extract_category_links
from dermaterialspezialistlib.category_pages_link_extractor import extract_all_category_pages_links
from dermaterialspezialistlib.product_detail_link_extractor import extract_all_product_detail_links
from dermaterialspezialistlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Der Materialspezialist E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Der Materialspezialist Downloader Started")
    logging.info("=" * 80)
