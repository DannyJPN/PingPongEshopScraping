"""
Asics E-shop Downloader

Downloads product data from Asics e-shop and exports to CSV.

Usage:
    python asics_downloader.py --result_folder H:/Desaka/Asics --debug --overwrite
"""
...
from asicslib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from asicslib.category_link_extractor import extract_category_links
from asicslib.category_pages_link_extractor import extract_all_category_pages_links
from asicslib.product_detail_link_extractor import extract_all_product_detail_links
from asicslib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Asics E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Asics Downloader Started")
    logging.info("=" * 80)
