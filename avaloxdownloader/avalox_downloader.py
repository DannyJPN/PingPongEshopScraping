"""
Avalox E-shop Downloader

Downloads product data from Avalox e-shop and exports to CSV.

Usage:
    python avalox_downloader.py --result_folder H:/Desaka/Avalox --debug --overwrite
"""
...
from avaloxlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from avaloxlib.category_link_extractor import extract_category_links
from avaloxlib.category_pages_link_extractor import extract_all_category_pages_links
from avaloxlib.product_detail_link_extractor import extract_all_product_detail_links
from avaloxlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Avalox E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Avalox Downloader Started")
    logging.info("=" * 80)
