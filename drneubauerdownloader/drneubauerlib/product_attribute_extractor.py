"""
Extracts product attributes from Dr. Neubauer product detail pages.

Dr. Neubauer uses Shopware/WooCommerce platform - German e-commerce:
...
from drneubauerlib.constants import MAIN_URL
