"""
Dr. Neubauer E-shop Downloader

Downloads product data from Dr. Neubauer e-shop and exports to CSV.

Usage:
    python drneubauer_downloader.py --result_folder H:/Desaka/DrNeubauer --debug --overwrite
"""
...
from drneubauerlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from drneubauerlib.category_link_extractor import extract_category_links
from drneubauerlib.category_pages_link_extractor import extract_all_category_pages_links
from drneubauerlib.product_detail_link_extractor import extract_all_product_detail_links
from drneubauerlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Dr. Neubauer E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Dr. Neubauer Downloader Started")
    logging.info("=" * 80)
