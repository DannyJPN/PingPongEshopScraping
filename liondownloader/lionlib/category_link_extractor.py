"""
Extracts category links from Lion main page.

Lion.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from lionlib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Lion uses Shopify - looks for /collections/ URLs in navigation.
