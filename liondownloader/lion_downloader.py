"""
Lion E-shop Downloader

Downloads product data from Lion e-shop and exports to CSV.

Usage:
    python lion_downloader.py --result_folder H:/Desaka/Lion --debug --overwrite
"""
...
from lionlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from lionlib.category_link_extractor import extract_category_links
from lionlib.category_pages_link_extractor import extract_all_category_pages_links
from lionlib.product_detail_link_extractor import extract_all_product_detail_links
from lionlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Lion E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Lion Downloader Started")
    logging.info("=" * 80)
