"""
Andro E-shop Downloader

Downloads product data from Andro e-shop and exports to CSV.

Usage:
    python andro_downloader.py --result_folder H:/Desaka/Andro --debug --overwrite
"""
...
from androlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from androlib.category_link_extractor import extract_category_links
from androlib.category_pages_link_extractor import extract_all_category_pages_links
from androlib.product_detail_link_extractor import extract_all_product_detail_links
from androlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Andro E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Andro Downloader Started")
    logging.info("=" * 80)
