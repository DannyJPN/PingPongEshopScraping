"""
Carlton E-shop Downloader

Downloads product data from Carlton e-shop and exports to CSV.

Usage:
    python carlton_downloader.py --result_folder H:/Desaka/Carlton --debug --overwrite
"""
...
from carltonlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from carltonlib.category_link_extractor import extract_category_links
from carltonlib.category_pages_link_extractor import extract_all_category_pages_links
from carltonlib.product_detail_link_extractor import extract_all_product_detail_links
from carltonlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Carlton E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Carlton Downloader Started")
    logging.info("=" * 80)
