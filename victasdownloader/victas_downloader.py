"""
Victas E-shop Downloader

Downloads product data from Victas e-shop and exports to CSV.

Usage:
    python victas_downloader.py --result_folder H:/Desaka/Victas --debug --overwrite
"""
...
from victaslib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from victaslib.category_link_extractor import extract_category_links
from victaslib.category_pages_link_extractor import extract_all_category_pages_links
from victaslib.product_detail_link_extractor import extract_all_product_detail_links
from victaslib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Victas E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Victas Downloader Started")
    logging.info("=" * 80)
