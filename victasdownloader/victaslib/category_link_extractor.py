"""
Extracts category links from Victas main page.

Victas.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from victaslib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Victas uses Shopify - looks for /collections/ URLs in navigation.
