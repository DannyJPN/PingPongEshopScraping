"""
Extracts category links from Stiga main page.

Stiga.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from stigalib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Stiga uses Shopify - looks for /collections/ URLs in navigation.
