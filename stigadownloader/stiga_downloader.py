"""
Stiga E-shop Downloader

Downloads product data from Stiga e-shop and exports to CSV.

Usage:
    python stiga_downloader.py --result_folder H:/Desaka/Stiga --debug --overwrite
"""
...
from stigalib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from stigalib.category_link_extractor import extract_category_links
from stigalib.category_pages_link_extractor import extract_all_category_pages_links
from stigalib.product_detail_link_extractor import extract_all_product_detail_links
from stigalib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Stiga E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Stiga Downloader Started")
    logging.info("=" * 80)
