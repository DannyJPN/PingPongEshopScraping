"""
Giant Dragon E-shop Downloader

Downloads product data from Giant Dragon e-shop and exports to CSV.

Usage:
    python giantdragon_downloader.py --result_folder H:/Desaka/GiantDragon --debug --overwrite
"""
...
from giantdragonlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from giantdragonlib.category_link_extractor import extract_category_links
from giantdragonlib.category_pages_link_extractor import extract_all_category_pages_links
from giantdragonlib.product_detail_link_extractor import extract_all_product_detail_links
from giantdragonlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Giant Dragon E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Giant Dragon Downloader Started")
    logging.info("=" * 80)
