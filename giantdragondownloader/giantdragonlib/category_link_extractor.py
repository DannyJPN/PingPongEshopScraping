"""
Extracts category links from Giant Dragon main page.

Giant Dragon.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from giantdragonlib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Giant Dragon uses Shopify - looks for /collections/ URLs in navigation.
