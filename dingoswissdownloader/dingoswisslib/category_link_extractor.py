"""
Extracts category links from Dingo Swiss main page.

Dingo Swiss.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from dingoswisslib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Dingo Swiss uses Shopify - looks for /collections/ URLs in navigation.
