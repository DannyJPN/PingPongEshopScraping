"""
Dingo Swiss E-shop Downloader

Downloads product data from Dingo Swiss e-shop and exports to CSV.

Usage:
    python dingoswiss_downloader.py --result_folder H:/Desaka/DingoSwiss --debug --overwrite
"""
...
from dingoswisslib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from dingoswisslib.category_link_extractor import extract_category_links
from dingoswisslib.category_pages_link_extractor import extract_all_category_pages_links
from dingoswisslib.product_detail_link_extractor import extract_all_product_detail_links
from dingoswisslib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Dingo Swiss E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Dingo Swiss Downloader Started")
    logging.info("=" * 80)
