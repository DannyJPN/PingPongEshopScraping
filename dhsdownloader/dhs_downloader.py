"""
DHS E-shop Downloader

Downloads product data from DHS e-shop and exports to CSV.

Usage:
    python dhs_downloader.py --result_folder H:/Desaka/DHS --debug --overwrite
"""
...
from dhslib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from dhslib.category_link_extractor import extract_category_links
from dhslib.category_pages_link_extractor import extract_all_category_pages_links
from dhslib.product_detail_link_extractor import extract_all_product_detail_links
from dhslib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="DHS E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("DHS Downloader Started")
    logging.info("=" * 80)
