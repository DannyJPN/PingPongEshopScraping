"""
Extracts category links from DHS main page.

DHS.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from dhslib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    DHS uses Shopify - looks for /collections/ URLs in navigation.
