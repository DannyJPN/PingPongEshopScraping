"""
Extracts category links from Nexy main page.

Nexy.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from nexylib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Nexy uses Shopify - looks for /collections/ URLs in navigation.
