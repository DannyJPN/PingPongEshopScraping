"""
Nexy E-shop Downloader

Downloads product data from Nexy e-shop and exports to CSV.

Usage:
    python nexy_downloader.py --result_folder H:/Desaka/Nexy --debug --overwrite
"""
...
from nexylib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from nexylib.category_link_extractor import extract_category_links
from nexylib.category_pages_link_extractor import extract_all_category_pages_links
from nexylib.product_detail_link_extractor import extract_all_product_detail_links
from nexylib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Nexy E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Nexy Downloader Started")
    logging.info("=" * 80)
