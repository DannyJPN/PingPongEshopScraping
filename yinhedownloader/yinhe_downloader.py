"""
Yinhe (Galaxy/Milky Way) E-shop Downloader

Downloads product data from Yinhe USA e-shop and exports to CSV.

Usage:
    python yinhe_downloader.py --result_folder H:/Desaka/Yinhe --debug --overwrite
"""
...
from yinhelib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from yinhelib.category_link_extractor import extract_category_links
from yinhelib.category_pages_link_extractor import extract_all_category_pages_links
from yinhelib.product_detail_link_extractor import extract_all_product_detail_links
from yinhelib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Yinhe (Galaxy/Milky Way) E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Yinhe (Galaxy/Milky Way) Downloader Started")
    logging.info("=" * 80)
    ...
    if not products:
        ...
        # Continue - maybe there are images to export
