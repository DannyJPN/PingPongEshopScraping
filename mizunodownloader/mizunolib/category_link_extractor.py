"""
Extracts category links from Mizuno main page.

Mizuno.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from mizunolib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Mizuno uses Shopify - looks for /collections/ URLs in navigation.
