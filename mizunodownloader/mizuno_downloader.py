"""
Mizuno E-shop Downloader

Downloads product data from Mizuno e-shop and exports to CSV.

Usage:
    python mizuno_downloader.py --result_folder H:/Desaka/Mizuno --debug --overwrite
"""
...
from mizunolib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from mizunolib.category_link_extractor import extract_category_links
from mizunolib.category_pages_link_extractor import extract_all_category_pages_links
from mizunolib.product_detail_link_extractor import extract_all_product_detail_links
from mizunolib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Mizuno E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Mizuno Downloader Started")
    logging.info("=" * 80)
