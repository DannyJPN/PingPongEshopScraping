"""
Extracts category links from Gambler main page.

Gambler.tt uses Shopify platform with standard collection structure.
"""
import logging
...
def extract_category_links(main_page_soup):
    ...
    Gambler uses Shopify - looks for /collections/ URLs in navigation.
