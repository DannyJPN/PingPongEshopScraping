"""
Gambler E-shop Downloader

Downloads product data from Gambler e-shop and exports to CSV.

Usage:
    python gambler_downloader.py --result_folder H:/Desaka/Gambler --debug --overwrite
"""
...
from gamblerlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from gamblerlib.category_link_extractor import extract_category_links
from gamblerlib.category_pages_link_extractor import extract_all_category_pages_links
from gamblerlib.product_detail_link_extractor import extract_all_product_detail_links
from gamblerlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Gambler E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Gambler Downloader Started")
    logging.info("=" * 80)
