"""
Extracts product attributes from Tibhar product detail pages.

Tibhar uses Shopware/WooCommerce platform - German e-commerce:
...
from tibharlib.constants import MAIN_URL
