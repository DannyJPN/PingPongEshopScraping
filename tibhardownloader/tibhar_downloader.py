"""
Tibhar E-shop Downloader

Downloads product data from Tibhar e-shop and exports to CSV.

Usage:
    python tibhar_downloader.py --result_folder H:/Desaka/Tibhar --debug --overwrite
"""
...
from tibharlib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from tibharlib.category_link_extractor import extract_category_links
from tibharlib.category_pages_link_extractor import extract_all_category_pages_links
from tibharlib.product_detail_link_extractor import extract_all_product_detail_links
from tibharlib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Tibhar E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Tibhar Downloader Started")
    logging.info("=" * 80)
