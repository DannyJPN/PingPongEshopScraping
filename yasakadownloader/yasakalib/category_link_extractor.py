"""
Extracts category links from Yasaka main page.

Yasaka.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from yasakalib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Yasaka uses Shopify - looks for /collections/ URLs in navigation.
