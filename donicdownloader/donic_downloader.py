"""
Donic E-shop Downloader

Downloads product data from Donic e-shop and exports to CSV.

Usage:
    python donic_downloader.py --result_folder H:/Desaka/Donic --debug --overwrite
"""
...
from doniclib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from doniclib.category_link_extractor import extract_category_links
from doniclib.category_pages_link_extractor import extract_all_category_pages_links
from doniclib.product_detail_link_extractor import extract_all_product_detail_links
from doniclib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Donic E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Donic Downloader Started")
    logging.info("=" * 80)
