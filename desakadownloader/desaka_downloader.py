"""
Desaka E-shop Downloader

Downloads product data from Desaka e-shop and exports to CSV.

Usage:
    python desaka_downloader.py --result_folder H:/Desaka/Desaka --debug --overwrite
"""
...
from desakalib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from desakalib.category_link_extractor import extract_category_links
from desakalib.category_pages_link_extractor import extract_all_category_pages_links
from desakalib.product_detail_link_extractor import extract_all_product_detail_links
from desakalib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Desaka E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Desaka Downloader Started")
    logging.info("=" * 80)
