"""
Extracts category links from Desaka main page.

Desaka.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from desakalib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Desaka uses Shopify - looks for /collections/ URLs in navigation.
