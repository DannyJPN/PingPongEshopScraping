"""
Cornilleau E-shop Downloader

Downloads product data from Cornilleau e-shop and exports to CSV.

Usage:
    python cornilleau_downloader.py --result_folder H:/Desaka/Cornilleau --debug --overwrite
"""
...
from cornilleaulib.constants import DEFAULT_RESULT_FOLDER, MAIN_URL, MAIN_PAGE_FILENAME, CSV_OUTPUT_NAME, LOG_DIR
from cornilleaulib.category_link_extractor import extract_category_links
from cornilleaulib.category_pages_link_extractor import extract_all_category_pages_links
from cornilleaulib.product_detail_link_extractor import extract_all_product_detail_links
from cornilleaulib.product_attribute_extractor import extract_products


def parse_arguments():
    """Parse command line arguments."""
    parser = ArgumentParser(description="Cornilleau E-shop Downloader")
...
def main():
    ...
    logging.info("=" * 80)
    logging.info("Cornilleau Downloader Started")
    logging.info("=" * 80)
