"""
Extracts category links from Cornilleau main page.

Cornilleau.tt uses Shopify platform with standard collection structure.
"""
import logging
from urllib.parse import urljoin
from tqdm import tqdm
from cornilleaulib.constants import MAIN_URL
...
def extract_category_links(main_page_soup):
    ...
    Cornilleau uses Shopify - looks for /collections/ URLs in navigation.
